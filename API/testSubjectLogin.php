      ...
      try {
          ...
          if($numrows > 0){
              for ($ri = 0; $ri < $numrows; $ri++) {
                $row = $result[$ri];
                $details['id'] = $row['id'];
                $details['SubjectId'] = $row['SubjectId'];
                $details['Username'] = $row['Username'];
                $details['TestChamber'] = $row['TestChamber'];
                $details['DateOfBirth'] = $row['DateOfBirth'];
                $details['TotalScore'] = $row['TotalScore'];
                $details['Alive'] = $row['Alive'];
